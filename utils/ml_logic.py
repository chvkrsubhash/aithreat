...
def generate_pdf_report(data):
    ...
    try:
        ...
        pdf.cell(0, 10, "AI-Threat-Sentry Advanced Analysis Report", ln=True, align="C")
        pdf.set_font("Helvetica", "", 10)
        pdf.cell(0, 10, "Generated by AI-Threat-Sentry XAI Engine", ln=True, align="C")
        pdf.ln(5)
            ...
            for name, b64 in data['shap_plots'].items():
                if b64:
                    ...
                    try:
                        ...
                        pdf.image(img_buffer, w=pdf.epw)
